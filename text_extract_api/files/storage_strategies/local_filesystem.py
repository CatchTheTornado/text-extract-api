...
class LocalFilesystemStorageStrategy(BaseStorageStrategy):
    def __init__(self, context):
        ...
        self.create_subfolders = self.context["settings"].get(
            "create_subfolders", False
        )
        self.subfolder_names_format = self.context["settings"].get(
